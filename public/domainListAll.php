...
// -------
//
function ciniki_sysadmin_domainListAll($ciniki) {
    //
    ...
    if( ($ciniki['session']['user']['perms'] & 0x01) != 0x01 ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.sysadmin.21', 'msg'=>'Access denied'));
    }
    ...
    $rc = ciniki_core_dbHashQueryTree($ciniki, $strsql, 'ciniki.sysadmin', array(
